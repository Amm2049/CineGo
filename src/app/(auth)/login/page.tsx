    ...
    <main className="min-h-screen flex items-center justify-center px-4 bg-[#03030d] relative overflow-hidden">
      ...
      <div className="w-full max-w-sm relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-[#c7d2fe] text-xs font-medium mt-1">Access your cinema passes and reservations</p>
        </div>
        ...
        <div className="glass-panel-cobalt rounded-2xl p-6 sm:p-7 space-y-4 shadow-2xl">
          ...
          >
            Sign In — Coming in Phase 3
          </button>
        </div>

        <p className="text-center text-xs text-[#c7d2fe] font-medium mt-5">
          New to CineGo?{" "}
          <Link href="/register" className="text-white hover:text-[#c7d2fe] font-bold underline underline-offset-4 decoration-[#2500f0] transition-colors">
            Create an account
          </Link>
        </p>
      </div>
